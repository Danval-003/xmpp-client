...
const LoginSection:React.FC<LoginSectionProps> = ({setIsLogin}) => {
  ...
  return (
    <div className="w-full h-full p-10">
      <h1 className="text-4xl uppercase font-bold text-[#f8f8f8]">Login</h1>
      <div className="mt-10" onSubmit={handleLogin}>
        ...
        <button
        type="button" className="w-full h-10 mt-5 bg-[#f8f8f8] text-[#333] font-bold uppercase rounded-lg hover:bg-[#e5e5e5] focus:outline-none"
        onClick={() => handleLogin()}
        >Login</button>
      </div>
